...
PageSetupStore::PageSetupStore(domain::PageSetupTopic& topic) : topic_(topic) {}
...
void PageSetupStore::ReceivePageSetup(
  ...
  topic_.Publish(page_setup_config_);
}

void PageSetupStore::SendPageSetup() { topic_.Publish(page_setup_config_); }
