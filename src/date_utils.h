...
inline boost::gregorian::date string_to_boost_date(const std::string& date_string, const date_format_descriptor& format)
{
...
inline int CheckDateInterval(const boost::gregorian::date& begin_date, const boost::gregorian::date& end_date)
{
	int case_id = 0;
