...
public:
  ...
  ShapeConfiguration(std::string name, bool outline_visible, bool fill_visible, float line_width,
                     OutlineColorValue outline_color, FillColorValue fill_color)
      : name_(std::move(name)), outline_visible_(outline_visible), fill_visible_(fill_visible),
        line_width_(line_width),
        outline_color_({outline_color.value[0], outline_color.value[1], outline_color.value[2],
                        outline_color.value[3]}),
        fill_color_(
            {fill_color.value[0], fill_color.value[1], fill_color.value[2], fill_color.value[3]})
  {
  }
  ...
  [[nodiscard]] glm::vec4 OutlineColor() const
  {
    ...
    if (outline_visible_) {
      value = {outline_color_[0], outline_color_[1], outline_color_[2], outline_color_[3]};
    }
  ...
  {
    return {outline_color_[0], outline_color_[1], outline_color_[2], outline_color_[3]};
  }
...
public:
  ...
  ShapeConfigurationStorage &operator=(const ShapeConfigurationStorage &) = delete;
  ...
  ShapeConfiguration &operator[](size_t index) { return shape_configurations.at(index); }
  const ShapeConfiguration &operator[](size_t index) const
  {
    return shape_configurations.at(index);
  }

  [[nodiscard]] ShapeConfiguration GetShapeConfiguration(const std::string &name) const
  {
...
private:
  static std::vector<ShapeConfiguration> BuildDefaults()
  {
    ...
    const glm::vec4 light_gray_transparent{kThreeQuarters, kThreeQuarters, kThreeQuarters,
                                           kQuarter};
    ...
    return {
        ShapeConfiguration{"Page Margin", true, false, kLineWidthThin,
                           ShapeConfiguration::OutlineColorValue{black_opaque},
                           ShapeConfiguration::FillColorValue{white_transparent}},
        ShapeConfiguration{"Title Frame", true, false, kLineWidthThick,
                           ShapeConfiguration::OutlineColorValue{dark_gray},
                           ShapeConfiguration::FillColorValue{white_transparent}},
        ShapeConfiguration{"Calendar Labels", true, false, kLineWidthVeryThin,
        ...
        ShapeConfiguration{"Months Shapes", true, false, kLineWidthThin,
                           ShapeConfiguration::OutlineColorValue{mid_gray},
                           ShapeConfiguration::FillColorValue{mid_gray_transparent}},
        ShapeConfiguration{"Years Shapes", false, false, kLineWidthThin,
