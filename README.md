...
MIT, and it links Qt under the [LGPLv3](https://www.gnu.org/licenses/lgpl-3.0.html) — dynamically, unmodified. Help → Open Source Licenses shows every licence text the binary carries, and `cmake --install` places them beside it.
