...
**AGENTS.md-Verstösse — CONFIRMED (4):**
...
- ~~AGENTS.md ordnen und straffen~~ (2026-07-10) — dedupliziert (einkopierter `TODO.txt`-Block aufgelöst, Prinzipien-Listen vereint), nach Nutzungsfluss neu gegliedert, Referenz-Links ergänzt, Untermodul-Liste korrigiert (fünf statt drei).
