...
Take `--dump-png` for a clean high-DPI export of the page itself, `--dump-window-png` for the real GUI including chrome. `--dump-window-png` gets queued on the event loop, so the first paint has already happened.
